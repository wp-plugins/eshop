<?php
if ('epn.php' == basename($_SERVER['SCRIPT_FILENAME']))
...
class epn_class {
   ...
   function submit_epn_post() {
      ...
      $echo.='<label for="ppsubmit"><small>'.__('<strong>Note:</strong> Submit to finalize order at eProcessingNetwork.','eshop').'</small><br />
